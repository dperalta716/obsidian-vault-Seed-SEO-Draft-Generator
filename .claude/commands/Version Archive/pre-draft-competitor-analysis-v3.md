# pre-draft-competitor-analysis-v3
...
```
/pre-draft-competitor-analysis-v3 <keyword>
```
...
**v3 Improvement**: Uses `dataforseo-json.sh` shell script instead of MCP server for 60-80% token reduction and improved reliability on complex queries.
...
```
/pre-draft-competitor-analysis-v3 american ginseng
```
