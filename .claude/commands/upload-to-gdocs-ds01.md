...
2. **Automatically moving the doc to the DS-01 drafts folder** using the **google-drive skill**
...
5. **Move the document to DS-01 drafts folder** using the google-drive skill:
   - Execute bash script: `~/.claude/skills/google-drive/scripts/move-file.sh`
   - Parameters:
     * First argument: "david@david-peralta.com"
     * Second argument: The extracted document ID
     * Third argument: "1c6L_PMTktN3lNUz64TQpapA9pE--yY_V" (DS-01 drafts folder ID)
   - This moves the doc from the root folder to the DS-01 drafts folder
