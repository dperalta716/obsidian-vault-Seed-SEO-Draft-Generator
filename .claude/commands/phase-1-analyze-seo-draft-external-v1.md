# phase-1-analyze-seo-draft-external-v1

Performs competitive analysis of a published Seed blog article against top-ranking competitors and generates revision instructions for an **external human drafter** (Phase 1 content improvements).

## Usage

```
/phase-1-analyze-seo-draft-external-v1 <url_or_path> <primary_keyword>
```
...
```
/phase-1-analyze-seo-draft-external-v1 /cultured/probiotics-for-gut-health "probiotics for gut health"
```

or

```
/phase-1-analyze-seo-draft-external-v1 https://www.seed.com/cultured/signs-probiotics-are-working "signs probiotics are working"
```
