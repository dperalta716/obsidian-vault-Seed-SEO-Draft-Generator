...
# Usage: ./add-rows.sh "user@example.com" "spreadsheet_id" "sheet_id" "start_index" "num_rows"
...
SPREADSHEET_ID="$2"
SHEET_ID="$3"
START_INDEX="$4"  # 0-based row index where to insert
NUM_ROWS="$5"     # Number of rows to insert
