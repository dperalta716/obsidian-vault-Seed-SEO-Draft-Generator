...
- `/review-claims-3-v3` - Reviews claims in the most recent draft in /Fable-Sandbox/Generated-Drafts/ or /Phase 1 Draft Revsions/
...
═══════════════════════════════════════════════════
📝 DONE — this file is the calibration finish line:
═══════════════════════════════════════════════════

(SANDBOX: do NOT run any upload-to-gdocs command — the pipeline ends at the file just saved)
```

**NOTE:** The upload step that normally follows is removed in this sandbox copy. Use the exact path including the version number that was created (e.g., `v5-claims-verified.md`).
