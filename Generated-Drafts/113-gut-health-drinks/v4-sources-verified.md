...
status: draft
note: "Step 3 Sources verification via CrossRef. 9/9 DOIs return CrossRef 200 with matching author+title; Allegretti = Claims Library canonical PubMed citation (authoritative). Standardized the two Bodagh body inline links from PMC6341159 to the verified DOI 10.1002/fsn3.807 to match the Citations list."
