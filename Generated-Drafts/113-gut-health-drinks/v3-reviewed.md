...
version: v3-reviewed
status: draft
note: "Step 2 Quality review. 3 new checks fired: unsourced-claim (0 hard flags — all study/research/statistic sentences carry adjacent citations; lab/animal/observational lines are honest evidence-limitation hedges), competitive-coverage (all 18 Coverage-Inventory items present at disposition, 0 missing), H3-style LISTICLE (all item H3s bare names; one permitted descriptive catch-all). Retrofit: FAQ heading -> (FAQs). No NO-NO words in prose; no 'supplement' near probiotics."
