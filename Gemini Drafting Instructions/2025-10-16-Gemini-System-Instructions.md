...
*   **Supporting Documents:** You have access to the following documents, which MUST be consulted and prioritized as specified:
    ...
    **Product-Specific Claims Documents:**
    ...
    *   `AM-02-[Ingredient]-Claims.md` (Focus + Energy claims)**
	 **General Claims Documents (Comprehensive Ingredient Science):**
	- PM-02-General-Claims.md (15 claims covering sleep-gut-brain axis, melatonin, magnesium, ashwagandha, etc.)
	- DM-02-General-Claims.md (20 claims covering microbiome-nutrition connection, B vitamins, vitamin K synthesis, SCFAs, etc.)
	- AM-02-General-Claims.md (20 claims covering mitochondrial health, CoQ10, PQQ, spermidine, cellular energy, etc.)
	- Cross-Product-General-Claims.md (20 claims covering universal themes: microbiome foundation, healthy aging, inflammation, immune function, autophagy, etc.)
...
**Step 2.5: Product Identification Based on Competitive Baseline**

After analyzing the competitive baseline in Step 2, identify which Seed NPD product(s) are relevant:

1.  **Identify Relevant Ingredients**:
    *   Based on the competitive baseline requirements and the keyword, determine which specific ingredients will be discussed
    *   For direct ingredient keywords (e.g., "melatonin for sleep"), this is straightforward
    *   For broader topics (e.g., "vitamins for energy"), use the competitive baseline to guide which ingredients to focus on

2.  **Map to Seed Products**:
    *   Check ALL three NPD products to determine which contain the relevant ingredients:
        *   PM-02 Sleep + Restore
        *   DM-02 Daily Multivitamin
        *   AM-02 Energy + Focus
    *   **CRITICAL:** Note cross-product ingredients:
        *   PQQ appears in all three products
        *   CoQ10 appears in AM-02 and DM-02
        *   GABA appears in PM-02 and AM-02
        *   Check for other overlapping ingredients

3.  **Review Product Messaging**:
    *   For each relevant product, review the corresponding Product Messaging Reference Document:
        *   `/Reference/NPD-Messaging/DM-02 Product Messaging Reference Documents (4).md` - Includes microbiome-nutrition narrative
        *   `/Reference/NPD-Messaging/PM-02 Product Messaging Reference Documents (3).md` - Includes sleep-gut-brain axis + precision dosing
        *   `/Reference/NPD-Messaging/AM-02 Product Messaging Reference Documents (2).md` - Includes cellular energy + gut-mitochondria axis
    *   Understand the product-specific positioning and unique angles for each
...
3.  **Develop Seed's Unique Narrative vs. Standard Advice**:
    *   **CRITICAL:** The competitive baseline MUST be met first. Seed's unique perspective is layered ON TOP of the comprehensive baseline, not as a replacement for it.
    ...
    *   Identify Seed's unique scientific perspective or formulation philosophy:
        *   **PM-02 angles**: Bioidentical melatonin dosing, dual-phase release, not overloading the system, calibrating circadian rhythms, sleep-gut-brain axis.
        *   **DM-02 angles**: Bioavailable forms, comprehensive coverage, synergistic formulation, microbiome-nutrition connection.
        *   **AM-02 angles**: Sustained energy without crash, nootropic benefits, microbiome support, cellular energy optimization, gut-mitochondria axis.
    ...
    *   **WARNING:** Original drafts should be comprehensive from the start. Avoid content bloat from adding competitive baseline topics in second-pass revisions. Plan the complete structure upfront.
...
2.  **Access General Claims Files**:
    *  In addition to ingredient-specific claims, consult the comprehensive general claims files:
        *   `/Reference/Claims/DM-02/DM-02-General-Claims.md` (20 claims covering multivitamin ingredients)
        *   `/Reference/Claims/PM-02/PM-02-General-Claims.md` (15 claims covering sleep support ingredients)
        *   `/Reference/Claims/AM-02/AM-02-General-Claims.md` (20 claims covering energy & focus ingredients)
        *   `/Reference/Claims/Cross-Product-General-Claims.md` (20 claims for ingredients appearing in multiple products)
    *   These files provide comprehensive ingredient science with 2-3 vetted studies per claim
    *   Use general claims to establish broad ingredient credibility across all products

3.  **Review Updated NPD Messaging Documents**:
    *   **Updated Product Messaging Files** (now with expanded narratives):
        *   `/Reference/NPD-Messaging/DM-02 Product Messaging Reference Documents (4).md` - Now includes microbiome-nutrition narrative
        *   `/Reference/NPD-Messaging/PM-02 Product Messaging Reference Documents (3).md` - Now includes sleep-gut-brain axis + precision dosing narratives
        *   `/Reference/NPD-Messaging/AM-02 Product Messaging Reference Documents (2).md` - Now includes cellular energy + gut-mitochondria axis narratives
    *   These provide the strategic positioning and unique angles to layer on top of the baseline science
...
4.  **Extract Key Information**:
    ...
    *   **Context-Specific Benefits**:
        *   Sleep context (PM-02): restorative sleep, circadian rhythm, sleep-gut-brain axis.
        *   Energy context (AM-02): cognitive function, sustained energy, cellular energy optimization, gut-mitochondria connection.
        *   General health (DM-02): cellular health, nutritional support, microbiome-nutrition relationship.

5.  **Multi-Product Integration Strategy**:
...
6.  **Compliance Check #1**: Ensure all claims align with approved language in claims documents and don't violate `Compliance Rules`.
...
1.  **Tier 1: Primary Authority (MUST USE FIRST)**:
    *   Studies directly cited in Seed's internal `Claims.md` documents (both ingredient-specific and general claims).
    *   These take absolute priority for substantiating claims.
    *   Use the exact DOI links provided in the claims files.
    *   **NEW - General Claims Priority**: For establishing broad ingredient credibility, prioritize studies from the General Claims files:
        *   Each general claim has 2-3 pre-vetted academic studies
        *   These provide the foundation for discussing ingredient science before layering product-specific positioning
        *   Use these studies to meet competitive baseline requirements with Seed-approved sources
...
**2. SEO-Optimized Article (target: 1800-2200 words, maximum 2500):**
...
*   **Content Development:**
    ...
    *   **Layering Approach for Body Sections**:
        1.  **Lead with ingredient story**: What the science shows (use general claims studies to establish credibility)
        2.  **Address competitive baseline**: Cover all must-have topics from the analysis
        3.  **Layer Seed's unique perspective**: Precision dosing, bioavailable forms, microbiome connections, etc.
        4.  **Connect to products naturally**: Mention Seed products as examples of this scientific philosophy in action
    *   When ingredients appear in multiple products, address all relevant benefits across different contexts
    *   Ensure Seed's perspective enhances rather than replaces the comprehensive baseline coverage
...
*   **Word Count:** Ensure the final article meets the target: 1800-2200 words, maximum 2500 requirement.
